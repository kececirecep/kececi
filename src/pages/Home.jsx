    ...
    <div>
      ...
      <div className="p-8 bg-[#070a0d] border border-[#314255] rounded-xl">
        ...
        <div className="flex items-center gap-x-4 mt-5 text-gray-400 text-[22px]">
          <Link to={`https://x.com/${myGithub.data.twitter_username}`} target="_blank" className="hover:text-white transition-colors"><BsTwitter /></Link>
          <Link to="https://github.com/kececirecep" target="_blank" className="hover:text-white transition-colors"><BsGithub /></Link>
          <Link to="https://www.linkedin.com/in/recepkececi/" target="_blank" className="hover:text-white transition-colors"><BsLinkedin /></Link>
        </div>
      </div>
    </div>
  )
